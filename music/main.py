...
def get_gaspari_images(
    base_url, item_id, start_page, end_page, directory_path, zfill=3
):
...
get_gaspari_images(base_url, item_id, start_page, end_page, directory_path)
